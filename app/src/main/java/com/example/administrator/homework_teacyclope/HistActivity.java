...
public class HistActivity extends AppCompatActivity {
    ...
    private MySQLiteHistryHelper mOpenHelper;
    ...
    private void initListView() {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(HistActivity.this, WebCollectActivity.class);
                Bundle bundle=new Bundle();
                bundle.putString("id",mid);
                intent.putExtras(bundle);
                HistActivity.this.startActivity(intent);
            }
        });
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder builder=new AlertDialog.Builder(HistActivity.this);
                builder.setTitle("提示");
                ...
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MySQLiteOpenHelper helper=new MySQLiteOpenHelper(HistActivity.this);
    ...
    private void initData() {
        mOpenHelper=new MySQLiteHistryHelper(this);
        String path = getDatabasePath("history.db").getAbsolutePath();
        mDb = mOpenHelper.getReadableDatabase();
        mDb=SQLiteDatabase.openDatabase(path,null,SQLiteDatabase.OPEN_READWRITE);
        Cursor cursor = mDb.query("myHistory", new String[]{
        ...
        while (cursor.moveToNext()){
            ...
            Log.i("TAG", "----------->历史记录datas---------------:" +datas.size());
        }
        cursor.close();
        mDb.close();
    }
